 ...
 *
 * The export package has to be one portable file that opens anywhere, and the
 * studio deliberately has no dependencies of its own beyond what the repository
 * already installs - so the archive is built by hand. Stored entries are a
 * valid ZIP; the payload is mostly PNG and JSON, which barely compress anyway.
 */
