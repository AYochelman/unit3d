...
export const BOT_ANSWERS: BotAnswer[] = [
  ...
  },
  {
    id: "materials",
    chip: "באיזה חומרים?",
    keys: ["חומר", "פילמנט", "pla", "petg", "tpu", "abs", "רזין", "resin", "משי", "silk", "מאט"],  // tpu stays a KEY so someone who asks for it gets the honest answer
    text:
      "PLA ו-PLA+ לחפצים יומיומיים, PLA מאט לגימור נקי בלי שכבות, PLA משי לברק מתכתי, PETG לכל מה שיושב בשמש או במים (תגים לחיות, חלקי רכב), ו-ABS לחלקים הנדסיים. TPU גמיש לחלקים רכים, אבל ממנו נשאר לי כרגע רק שחור. אם תגיד לי איפה החפץ הולך לחיות — אני אבחר במקומך.",
    next: ["colors", "price"],
  },
  {
    id: "colors",
