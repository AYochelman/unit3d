...
export const BOT_ANSWERS: BotAnswer[] = [
  ...
  },
  {
    ...
    text:
      "PLA ו-PLA+ לחפצים יומיומיים, PLA מאט לגימור נקי בלי שכבות, PLA משי לברק מתכתי, PETG לכל מה שיושב בשמש או במים (תגים לחיות, חלקי רכב), ו-ABS לחלקים הנדסיים. TPU גמיש לא מודפס אצלי כרגע. אם תגיד לי איפה החפץ הולך לחיות — אני אבחר במקומך.",
    next: ["colors", "price"],
  },
  {
    id: "colors",
