...
export const REVIEWS: Review[] = [
  ...
  { id: "r3", name: "רון", tag: "גיימר מחיפה", seg: "private", stars: 5, when: "לפני 3 שבועות", item: "דרקון מינימליסטי", hue: 145, href: "/products/mw-1645081", txt: "לקחתי אותו למדף הגיימינג ליד המסך. הקווים חדים, בלי שום סימני תמיכות, והשחור מאט יוצא בדיוק כמו בתמונה. יושב יפה גם ליד מסך גדול." },
  { id: "r4", name: "שיר", tag: "שייטת 13", seg: "soldier", stars: 5, when: "לפני חודש", item: "סמל יחידה · פסל שולחן", art: "trophy", hue: 195, href: "/catalog", txt: "איכות מטורפת. הסמל יצא חד ובהיר, ההגמרה החיצונית מושלמת. ממליצה לכל החבר'ה." },
  { id: "r5", name: "דניאלה", tag: "מנהלת תפעול · MoonTech", seg: "b2b", stars: 5, when: "לפני חודש", item: "80 מחזיקים ממותגים", art: "nameplate", hue: 190, href: "/b2b", txt: "הזמנו 80 מחזיקי מפתחות עם הלוגו שלנו לוועידה. חשבונית מס מסודרת, אריזה אישית לכל עובד, הגיע יומיים לפני התאריך. ספק שאני חוזרת אליו." },
  { id: "r6", name: "נטע", tag: "תושבת רעננה", seg: "private", stars: 5, when: "לפני שבועיים", item: "וו מגבת נועל-אוטומטי", hue: 30, href: "/products/mw-1971172", txt: "הוו תופס את המגבת לבד בלי שום מנגנון, ופשוט לא נופל. הדבקתי אותו בשירותים לפני חודשיים והוא עדיין במקום. קניתי עוד שניים למקלחת." },
  { id: "r7", name: "איתי", tag: "גולני 13", seg: "soldier", stars: 5, when: "לפני 5 ימים", item: "סמל גולני", art: "dogtag", hue: 90, href: "/catalog", txt: "הטופס שלהם שומר את כל הבחירות שעשית. נכנסתי, בחרתי, שלחתי. שיחה בוואטסאפ אחר כך והכל סגור." },
  { id: "r8", name: "גיא", tag: "VP People · Pixie", seg: "b2b", stars: 5, when: "לפני חודשיים", item: "35 פיגורות ממותגות", art: "torso", hue: 10, href: "/b2b", txt: "חיפשנו welcome-kit שלא ישכב בארון. 35 פיגורות מיניאטוריות בעיצוב הלוגו, צבע מותג מדויק, ארוז יפה. עובדים חדשים בטירוף." },
  { id: "r9", name: "לירון", tag: "מורת מתמטיקה", seg: "family", stars: 5, when: "לפני 3 שבועות", item: "שועל חולם · לואו-פולי", hue: 25, href: "/products/mw-1645161", txt: "קניתי מתנה לתלמיד שעבר ניתוח. שועל קטן ישן, בכתום, נכנס בדיוק בכף יד. ההורים צילמו אותו איתו בבית החולים." },
  { id: "r10", name: "אביב", tag: "חובב פידג'טים", seg: "private", stars: 5, when: "לפני שבוע", item: "דרקון מפרקי גמיש", hue: 90, href: "/fidgets", txt: "הדרקון הגיע מפרק אחד ומתנועע לכל אורכו, בלי טיפת דבק ובלי חלק שנתקע. הילדים במשרד לא מפסיקים לשחק בו. לקוח חוזר." },
  { id: "r11", name: "אורי", tag: "בעל כלב · חולון", seg: "private", stars: 5, when: "לפני 10 ימים", item: "תג לחיה עם שם וטלפון", hue: 30, href: "/products/mw-2868647", txt: "התג של לוקה שרד ים, בוץ ושלושה חודשים. השם והטלפון עדיין קריאים כמו ביום הראשון. הזמנתי עוד אחד לכלבה החדשה." },
  { id: "r12", name: "הילה", tag: "מעצבת פנים", seg: "private", stars: 5, when: "לפני שבועיים", item: "מעמד עטים ואגרטל · וורונוי", hue: 165, href: "/products/mw-2125984", txt: "לקוחה שלי ביקשה משהו לפינת הכניסה. הרשת האורגנית נראית כמו קרמיקה יצוקה, לא כמו הדפסה. כבר הזמנתי שניים נוספים למשרד שלי." },
  { id: "r13", name: "עומר", tag: "אבא לשלושה", seg: "family", stars: 5, when: "לפני 4 ימים", item: "סמיסקי עם חתול על הראש", hue: 140, href: "/products/mw-2735060", txt: "קניתי לבת שאוספת סמיסקי והיא נדלקה. החתול על הראש יצא נקי לגמרי, בלי שריטות שכבות. עומד לה על שולחן הכתיבה מאז." },
  { id: "r14", name: "רותם", tag: "מנהלת משרד · Aquila", seg: "b2b", stars: 4, when: "לפני חודש", item: "מעמדי כרטיסי ביקור לקבלה", hue: 260, href: "/products/mw-26806", txt: "המעמדים יצאו מדויקים והכרטיסים נשלפים חלק. לקח יום יותר ממה שסוכם בגלל שינוי שביקשנו באמצע, אבל עדכנו אותי בזמן. נחזור." },
];
