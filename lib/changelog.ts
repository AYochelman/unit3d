...
export const CHANGELOG: ChangeDay[] = [
  {
    date: "2026-09-10",
    items: [
      { kind: "admin", text: "בלשונית המוצרים אפשר עכשיו להעביר מוצר לקטגוריה אחרת בלחיצה, ולהוריד מוצר מהחנות בלחיצה." },
      { kind: "admin", text: "נוספה לשונית עדכונים — יומן של כל מה שנוסף לחנות, יום אחר יום." },
      { kind: "fix", text: "מודלים שנוספו לקולקציות ב-MakerWorld נכנסו ישר לחנות בלי אישור. עכשיו הם עוברים דרך תור האישורים, וגם 108 שכבר נכנסו הוחזרו לתור." },
      { kind: "fix", text: "הסריקה של MakerWorld רצה מעכשיו כל יום ב-08:00." },
      { kind: "fix", text: "לשונית ההוצאות נתקעה על \"טוען\" כשהטבלה במסד הנתונים חסרה — עכשיו היא אומרת מה חסר ומציגה את התיקון." },
      { kind: "fix", text: "בתור האישורים, ההחלטות נשמרו רק בזיכרון הדפדפן — כפתור השמירה נדבק עכשיו לראש המסך והדפדפן מזהיר לפני יציאה." },
      { kind: "feature", text: "הטיימלפסים נמשכים מכרטיס הזיכרון של המדפסת אל האתר — כולל אלה שהוקלטו בעבר." },
    ],
  },
  {
    date: "2026-09-09",
