...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  tiktok: <path d="M21 8.5a6.5 6.5 0 0 1-5-2.3v9.4a6.6 6.6 0 1 1-6.6-6.6c.34 0 .68.03 1 .09v3.13a3.5 3.5 0 1 0 2.6 3.38V2h3a6.5 6.5 0 0 0 5 6.5z" />,
  file: (
    <>
  ...
  sparkles: (
    <>
      ...
      <path d="M19 17l.7 2.1 2.3.4-2.3.4L19 22l-.7-2.1L16 19.5l2.3-.4z" />
    </>
  ),
